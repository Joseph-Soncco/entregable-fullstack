...
CREATE TABLE IF NOT EXISTS mangas (
  ...
  imagen      VARCHAR(255),
  CONSTRAINT fk_mangas_categoria FOREIGN KEY (idcategoria)
    REFERENCES categorias(idcategoria),
  CONSTRAINT fk_mangas_editorial FOREIGN KEY (ideditorial)
    REFERENCES editoriales(ideditorial),
  CONSTRAINT fk_mangas_genero FOREIGN KEY (idgenero)
    REFERENCES generos(idgenero),
  CONSTRAINT chk_precio_max CHECK (precio <= 300)
) ENGINE=INNODB;

INSERT INTO categorias (nombre) VALUES
  ('Normal'),('Especial'),('Box Set');
INSERT INTO editoriales (nombre) VALUES
  ('Shueisha'),('Kodansha'),('Panini');
INSERT INTO generos (nombre) VALUES
  ('Shōnen'),('Seinen'),('Shōjo'),('Josei'),('Acción'),('Aventura'),('Romance'),('Fantasía'),('Comedia');
INSERT INTO mangas
